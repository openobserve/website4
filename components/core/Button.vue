...
defineProps({
  ...
  variation: {
    ...
    default: () => ({
      ...
      requestdemo:
        "inline-block px-4 py-2 rounded-lg   bg-theme-herosecondaryButton-400 hover:bg-theme-herosecondaryButton-500 font-normal text-base text-white animate-left whitespace-nowrap",
    }),
  },
});
</script>
