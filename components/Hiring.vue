<template>
  <Section v-if="data.jobs.length > 0">
    ...
    <div class="container mx-auto flex flex-wrap justify-center px-4 md:px-0">
      <div
        class="flex flex-col bg-white border border-theme-primary-300 p-4 shadow rounded-lg w-full md:w-[calc(33.33333%-20px)] m-[10px]"
